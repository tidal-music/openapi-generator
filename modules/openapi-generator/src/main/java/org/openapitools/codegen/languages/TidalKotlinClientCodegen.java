...
public class TidalKotlinClientCodegen extends AbstractKotlinCodegen {

    private final Logger LOGGER = LoggerFactory.getLogger(TidalKotlinClientCodegen.class);
    ...
    /**
     * Constructs an instance of `TidalKotlinClientCodegen`.
     */
    public TidalKotlinClientCodegen() {
        super();
